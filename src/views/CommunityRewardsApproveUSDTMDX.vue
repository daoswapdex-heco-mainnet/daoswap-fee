            ...
            <v-card outlined>
              <v-card-title>
                <v-avatar size="24" class="mr-2">
                  <img :src="require('@/assets/logo.png')" alt="USDT-MDX" />
                </v-avatar>
                <span class="title font-weight-light">
                  USDT-MDX {{ $t("Available Amount") }}
                </span>
              </v-card-title>
              <v-card-text>
                <v-row align="center">
            ...
            <v-card-text>
              <v-row align="center">
                <v-col class="body-1" cols="12">
                  <p @click="handleCopy(USDT_MDX_DLT_Address, $event)">
                    USDT-MDX Pair Address: {{ USDT_MDX_DLT_Address }}
                    <v-icon>mdi-content-copy</v-icon>
                  </p>
                </v-col>
              </v-row>
...
import {
  CommunityRewardsUSDTMDXApproveContractAddress,
  USDT_MDX_DLT_Address
} from "@/constants";

            ...
            <v-card outlined>
              <v-card-title>
                <v-avatar size="24" class="mr-2">
                  <img :src="require('@/assets/logo.png')" alt="USDT-ETH" />
                </v-avatar>
                <span class="title font-weight-light">
                  USDT-ETH {{ $t("Available Amount") }}
                </span>
              </v-card-title>
              <v-card-text>
                <v-row align="center">
            ...
            <v-card-text>
              <v-row align="center">
                <v-col class="body-1" cols="12">
                  <p @click="handleCopy(USDT_ETH_DLT_Address, $event)">
                    USDT-ETH Pair Address: {{ USDT_ETH_DLT_Address }}
                    <v-icon>mdi-content-copy</v-icon>
                  </p>
                </v-col>
              </v-row>
...
import {
  CommunityRewardsUSDTETHApproveContractAddress,
  USDT_ETH_DLT_Address
} from "@/constants";
